...
async function sendMessage() {
    ...
    if (userMessage.length) { //if user message is not empty
        try {
            ...
            `)
            // for the loader, we will add a div with the class loader to the chat window
            // this will show a loading animation while the AI is processing the request
            document.querySelector(".chat-window .chat").insertAdjacentHTML("beforeend", `
            ...
            // we will add a div with the class model to the chat window
            document.querySelector(".chat-window .chat").insertAdjacentHTML("beforeend", `
              <div class="model">
                <p></p>
              </div>
            ...
            let modelMessages = ''; // variable to hold the model messages
            // stream the AI response
            for await (const chunk of result.stream) {
                const chunkText = chunk.text()
                // append the chunk of text to the modelMessages variable
                modelMessages = document.querySelectorAll(".chat-window .chat div.model")
                // we will add the chunk of text to the last model message
        ...
        // remove the loader after the AI response is received
